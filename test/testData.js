...
var test_ClassesData2 = [
    {
        cover: "/image/cover/react.png",
        name: 'React入门',
        info: 'React 起源于 Facebook 的内部项目，因为该公司对市场上所有 JavaScript MVC 框架，都不满意，就决定自己写一套，用来架设Instagram 的网站。做出来以后，发现这套东西很好用，就在2013年5月开源了。'
    },
    {
        cover: "/image/cover/react.png",
        name: 'React理解',
...
exports.allHotAEClasses = function(fn){
    fn({code:200,result:'ok',data:{"classesList":test_ClassesData}});
}
exports.allNewAEClasses = function(fn){
    var test_ClassesData_C = test_ClassesData.slice();
    test_ClassesData_C.reverse();
    fn({code:200,result:'ok',data:{"classesList":test_ClassesData_C}});
}
