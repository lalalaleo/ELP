...
const Discover = React.createClass({
    ...
    getHotList: function(){
        var array = this.props.classesData;
        this.setState({
            classesData:array
        });
    },
    getNewList: function(){
        var arr1 = this.props.classesData;
        var arr2 = [];
        var l = arr1.length;
        console.log(arr1);
        for(var i in arr1){
            arr2.push(arr1[l - i - 1]);
        }
        this.setState({
            classesData:arr2
        });
                ...
                <div id="Discover_hot-newclasses" className="page_content_item">
                    ...
                    <Row>
                        <RadioGroup defaultValue="a" size="large" style={{marginBottom:20}}>
                            <RadioButton value="a" onClick={this.getHotList}>最热</RadioButton>
                            <RadioButton value="b" onClick={this.getNewList}>最新</RadioButton>
                        </RadioGroup>
                    </Row>
                    <ClassesList data={ this.state.classesData } pageSize={5} />
                </div>
                {/*学霸们*/}
